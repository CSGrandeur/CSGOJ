...
const markedVersions = {
  master: 'https://fastly.jsdelivr.net/gh/markedjs/marked/marked.min.js'
};
  ...
  return fetch('https://data.jsdelivr.com/v1/package/npm/marked')
    ...
    .then(function(json) {
      for (let i = 0; i < json.versions.length; i++) {
        ...
        markedVersions[ver] = 'https://fastly.jsdelivr.net/npm/marked@' + ver + '/marked.min.js';
    ...
    .then(function() {
      return fetch('https://api.github.com/repos/markedjs/marked/commits')
        ...
        .then(function(json) {
          markedVersions.master = 'https://fastly.jsdelivr.net/gh/markedjs/marked@' + json[0].sha + '/marked.min.js';
        })
        .catch(function() {
          // do nothing
...
function addCommitVersion(value, text, commit) {
  ...
  markedVersions[value] = 'https://fastly.jsdelivr.net/gh/markedjs/marked@' + commit + '/marked.min.js';
  const opt = document.createElement('option');
