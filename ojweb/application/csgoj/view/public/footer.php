...
<footer class="text-muted">
    ...
    <p >Copyright © 2016-<?php echo date('Y'); ?> CSGrandeur. All Rights Reserved. <a href=https://beian.miit.gov.cn/ target="_blank">{$ICP_RECORD}</a><br/>
        Designer & Developer : <a href="http://blog.csgrandeur.cn" target="_blank">CSGrandeur</a>. <a href="https://github.com/CSGrandeur/CSGOJ" target="_blank">CSGOJ-一站式XCPC比赛系统 </a>.<br/>
